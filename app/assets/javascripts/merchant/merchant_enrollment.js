...
var MerchantEnrollment = (function() {
    ...
    var view = function(vnode) {
        return [m.trust("<div class=\"regular-16pt text-center\"><u>For Merchants</u></div>"),
                m.trust("<div class=\"text-center regular-14pt\">a <span class=\"toou\">tooU</span> is easy to redeem and costs you nothing.</div>" ),
                m.trust("<div class=\"text-center regular-14pt\">there are <span class=\"nofees\">NO FEES</span> for merchants.</div>"),
                m.trust("<div class=\"text-center regular-14pt\"><span class=\"toou\">tooU</span> will pay a premium for your products</div>"),
