Feature: Account Creation
  ...
  Background:
    Given A person named "Josh" with phone number "(310) 909-7243", email "josh@example.com", and device ""
    Given A person named "Elo" with phone number "(310) 800-1646", email "elo@example.com", and device "AC139"
